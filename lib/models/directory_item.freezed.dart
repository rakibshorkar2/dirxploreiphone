...
mixin _$DirectoryItem {
  ...
  /// Serializes this DirectoryItem to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DirectoryItem
...
class _$DirectoryItemImpl implements _DirectoryItem {
  ...
  @override
  String toString() {
    return 'DirectoryItem(name: $name, url: $url, isDirectory: $isDirectory, size: $size, lastModified: $lastModified)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, url, isDirectory, size, lastModified);
...
abstract class _DirectoryItem implements DirectoryItem {
  const factory _DirectoryItem(
      ...
      final int? size,
      final DateTime? lastModified}) = _$DirectoryItemImpl;
